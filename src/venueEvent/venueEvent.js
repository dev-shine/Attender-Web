      ...
      <div >
        <Row className="row-container">
          <Col sm={6} className="col-container-left" >
            <div>
              <img src={require('.././assets/background-2.png')} className="background-image" />
            </div>
            <div>
              ...
              <div className="text-container" align="center">
                ...
                <div className="subtext-container">
                  ...
                  <div className="content-style">
                    <h4 className="title-style">To give you the right profile we need to know if</h4>
                ...
                <div className="btn-container">
                  <Button className="pull-left" onClick={this.onLogin}>Venue/Establishment</Button>
                  <Button className="pull-right"onClick={this.onLogin}>Event Organiser</Button>
                </div>
              </div>
            </div>
          </Col>
          <Col sm={6} className="col-container-right">
            <div align="center">
              <img src={require('.././assets/logo&Text.png')} className="logo" />
            </div>
          </Col>
        </Row>
      </div>
