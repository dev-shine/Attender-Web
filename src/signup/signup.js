      ...
      <div >
        <Row className="row-container">
          <Col sm={4} className="col-container-left">
            <img src={require('.././assets/half-background image.png')} className="background-image" />
            <div>
              ...
              <Row>
                <Col smOffset={5} sm={8}>
                  <div className="header-style">
                    <h5>{`Already have an account? `}<a href="#" >Click here to login.</a></h5>
                  </div>
                  ...
                  <div>
                    <form>
                      ...
                      <div align="center">
                        ...
                        <h5 className="termscondition-top-style">By confirming your account you agree to our</h5>
                        <h5 className="termscondition-bottom-style">Terms and Conditions.</h5>
