...
class StaffEdit extends Component {
  ...
  componentDidMount() {
    if (this.props.profile) {
      ...
      this.setState(
        { ...this.props.profile, avatar: this.props.myProfile.avatar },
        () => {
  ...
  onSave = async () => {
    ...
    this.props.myProfile.avatar = image
    this.props.onSetProfileDetails(this.props.myProfile)
    alert("Success!")
    this.props.close()
                      ...
                      <Col sm={12} className="form-group">
                        ...
                        <span className="help-text pull-right">
                          {experience.additionalValue &&
                            experience.additionalValue.length}
                          /200
                        </span>
                      </Col>
                    </div>
