            ...
            <div className="col-sm-6 col-sm-offset-6">
              <div className="acc-c-content">
                <div className="acc-c-action">
                  <a onClick={() => this.props.onMain()} className="">
                    Home
                  </a>
                  <a onClick={() => this.props.onSignUp()} className="">
                    Sign Up
                  </a>
                </div>
                ...
                <div className="acc-c-body">
                  <p>
                    ...
                    {this.state.profile.fullname}, click Continue to finalise
                    your Attender profile.
                  </p>
                </div>
                <button
                  className="a-btn btn-round btn-outline"
