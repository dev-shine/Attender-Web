...
class Calendar extends Component {
  ...
  onTriggerCreateEventModal = () => {
    let openCreateEvent = this.state.openCreateEvent
    this.setState({ openCreateEvent: !openCreateEvent })
  }
  ...
  prevMonth = () => {
    let prevMonth = this.state.selectedDate.startOf('month').subtract(1, 'months')
      ...
      <div className="calendar-main card">
        <div className="calendar-main-header">
          ...
          <div className="add-event pull-right">
            <a onClick={()=> this.onTriggerCreateEventModal()} className="add-event-btn a-btn-circle">+</a>
            <div className="e-tooltip">Create Event</div>
          </div>
          <input type="text" className="a-plain-text" placeholder="Search something on your calendar"/>
        </div>
        <div className="calendar-main-date">
          <div className="row">
            <div className="calendar-main-date-navigator col-sm-6">
              <div className="calendar-main-head">
                <a onClick={()=> this.prevMonth()} className="pull-left"><i className="fa fa-angle-left"></i></a>
                <p>{this.state.selectedDate.format('MMMM').toUpperCase()}</p>
                <a onClick={()=> this.nextMonth()} className="pull-right"><i className="fa fa-angle-right"></i></a>
              </div>
                    ...
                    <div className="row seven-cols" key={id}>
                      {
                        week.days.map((day, id) => {
                          ...
                          if (this.state.today.isSame(day, 'day')) {
                            return (
                              <div key={id} onClick={()=> this.selectDate(day)} className="col-md-1"><span className="today">{day.format('D')}</span></div>
                            )
                          } else if (this.state.selectedDate.isSame(day, 'month')) {
                            return (
                              <div key={id} onClick={()=> this.selectDate(day)} className="col-md-1 on-month">
                                <span className={this.state.selectedDate.isSame(day, 'day') ? 'selected' : 'normal'}>{day.format('D')}</span>
                              </div>
                            )
                          } else {
                            return (
                              <div key={id} className="col-md-1"><span>{day.format('D')}</span></div>
                            )
                          }
          ...
          <div className="calendar-main-events-body v-scroll scroll">
            {
              this.state.currentEvents.map((event, index) => {
                return (
                  <div className={ (event == 1) ? "calendar-main-event selected" : "calendar-main-event"}>
                    <div className="row">
                      ...
                      <div className="col-sm-10">
                        ...
                        <p><i className="fa fa-clock-o"></i>&nbsp;10:00 AM - 12:00 PM</p>
                        <p>Venue: Oasis Beach <span className="pull-right"><i className="fa fa-map-marker"></i> Sydney, CBC</span></p>
                        <a>
                          <div className="drop-menu">
                            <img src={require('.././assets/icons/venue/menu.png')} onClick={()=> this.openDropdown(`c-${index}`)}/>
                            <div className="e-dropdown" style={{display: (this.state.eventDropdown == `c-${index}` )? 'block' : 'none'}}>
                              <p>Delete Event</p>
                              <p>View Details</p>
                            </div>
                          </div>
                    ...
                    <div className="col-sm-9">
                      <div className="row">
                        ...
                        <div className="col-sm-8">
                          ...
                          <p><i className="fa fa-map-marker"></i> Sydney, CBC</p>
                          <a>
                            <div className="drop-menu">
                              <img src={require('.././assets/icons/venue/menu.png')} onClick={()=> this.openDropdown(`e-${index}`)}/>
                              <div className="e-dropdown" style={{display: (this.state.eventDropdown == `e-${index}` )? 'block' : 'none'}}>
                                <div className="e-dropdown-content">
                                  <p>View Event</p>
                                  <p onClick={()=>this.onOpenEventManagement(index)}>Manage Event</p>
                                  <p>Delete Event</p>
                                </div>
                              </div>
                            </div>
    ...
    return (
      <div className={(this.state.openCreateEvent) ? 'a-modal show' : 'a-modal'}>
        <div className="a-modal-content">
          <span onClick={()=> this.onTriggerCreateEventModal()} className="a-close">&times;</span>
          <div className="row">
            <div className="col-sm-4">
              <p>CREATE EVENT</p>
              ...
              <div className="form-group">
                ...
                <textarea rows="2" cols="50" className="a-input"> </textarea>
              </div>
              <div className="form-group">
                <div className="row">
            ...
            <div className="col-sm-8">
                ...
                <div className="col-sm-7">
                  ...
                  <div className="icon-container">
                    <div className="a-icon-item-sm">
                      <a className="a-icon-action-sm"><i className="fa fa-glass" aria-hidden="true"></i></a>
                      <p className="xxm">Alcohol</p>
                    </div>
                    <div className="a-icon-item-active-sm">
                      <a className="a-icon-action-sm"><i className="fa fa-times-rectangle" aria-hidden="true"></i></a>
                  ...
                  <div className="search">
                    ...
                    <input className="a-plain-text" placeholder="Search Staff"/>
                  </div>
                </div>
                        ...
                        return (
                          <div className="sn-container">
                            ...
                            <div className="noe-container">
                              <a className="noe-action"><strong>–</strong></a>
                      ...
                      this.state.staffs.map((staff) => {
                        return (
                          <div className="my-staff">
                            <img className="profile-thumb my-staff-img" src="http://www.technodoze.com/wp-content/uploads/2016/03/default-placeholder.png" />
                            <p>Staff {staff}</p>
                            <small>Part Time</small>
                            <small>$20 - $23 /hour</small>
                            <button className="a-btn btn-dark btn-round"><small>Send Message</small></button>
              ...
              <button className="a-btn btn-dark btn-round pull-right">Save</button>
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div className={(this.state.openManageEvent) ? 'a-modal show' : 'a-modal'}>
        <div className="a-modal-content management">
          <span onClick={()=> this.onCloseEventManagement()} className="a-close">&times;</span>
          <div className="row">
            <div className="col-sm-5">
              <div className="header">
                <p>MANAGE YOUR EVENT</p>
                <p>EVENT FOR APRIL 5 ( <span>TODAY</span> )</p>
            ...
            <div className="col-sm-7">
              ...
              <div className="search">
                <i className="fa fa-search"></i>
                <input className="a-plain-text" placeholder="Enter name to find staff"/>
              </div>
